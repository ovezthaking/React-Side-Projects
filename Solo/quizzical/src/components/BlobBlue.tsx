export default function BlobBlue({ className }: { className: string }) {
    return (
        <svg className={'-z-10 ' + className} width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
