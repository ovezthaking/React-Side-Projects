export default function BlobYellow({ className }: {className: string}) {
    return (
        <svg className={'-z-10 ' + className} width="158" height="141" viewBox="0 0 158 141" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
